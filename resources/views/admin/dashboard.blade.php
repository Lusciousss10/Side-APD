<x-apps-layout>
    ...
    <div class="max-w-9xl mx-auto sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 mt-8 px-4">
            ...
            <a href="/admin/equip" class="relative rounded-lg shadow-lg h-[650px] group block bg-white dark:bg-gray-800 transition-transform transform hover:scale-105">
            ...
            <div class="flex flex-col space-y-4">
                <!-- Right Container (Top) -->
                <a href="/admin/crud" class="relative rounded-lg shadow-lg h-[205px] group block bg-white dark:bg-gray-800 border-l-8 border-blue-500 transition-transform transform hover:scale-105">
                ...
                <a href="/admin/violations" class="relative rounded-lg shadow-lg h-[205px] group block bg-white dark:bg-gray-800 border-l-8 border-blue-500 transition-transform transform hover:scale-105">
                    <div class="card-content absolute inset-0 flex items-center justify-center text-gray-900 dark:text-gray-100">
                        <div class="text-center p-4">
                ...
                <div class="relative rounded-lg shadow-lg h-[205px] bg-white dark:bg-gray-800 border-l-8 border-blue-500">
