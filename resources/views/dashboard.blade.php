<x-apps-layout>
    ...
    <div class="max-w-9xl mx-auto sm:px-6 lg:px-8 mt-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 px-4">
            ...
            <a href="equip" class="relative rounded-lg shadow-lg h-[450px] group block hover:bg-gray-900 transition duration-300 ease-in-out">
            ...
            <div class="flex flex-col space-y-8">
                ...
                <a href="userviolations" class="relative rounded-lg shadow-lg h-[215px] group block bg-white dark:bg-gray-800 border-l-8 border-blue-500 transition-transform transform hover:scale-105">
                ...
                <a class="relative rounded-lg shadow-lg h-[205px] group block bg-white dark:bg-gray-800 border-l-8 border-blue-500 transition-transform transform hover:scale-105">
