                        ...
                        <tr class="text-gray-700 dark:text-gray-200">
                            ...
                            <td class="py-2 px-4 border-b border-gray-300 dark:border-gray-600">
                                <div class="flex space-x-2">
                                    <a href="{{ route('user.download', $violation->id) }}" class="bg-blue-600 text-white px-4 py-2 rounded">Download</a>
                                    <form action="{{ route('user.destroy', $violation->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this item?');">
                                        @csrf
                                        @method('DELETE')
